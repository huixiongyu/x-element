<template>
  ...
  >
    ...
    >
      ...
      <template #content>
        <div class="hx-select__loading" v-if="states.loading"><Icon icon="spinner" spin /></div>
        <div class="hx-select__nodata" v-else-if="filterable && filteredOptions.length === 0">
          no matching data
        </div>
        <ul class="hx-select__menu" v-else>
          <template v-for="(item, index) in filteredOptions" :key="index">
            <li
              class="hx-select__menu-item"
              :class="{
