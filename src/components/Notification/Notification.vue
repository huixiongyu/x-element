<template>
  <Transition
    :name="`hx-notification-${transitionName}`"
  ...
  >
    ...
    >
      <Icon :icon="iconName" v-if="iconName" class="hx-notification__icon" />
      <div class="hx-notification__text">
        <div class="hx-notification__title">
          {{ title }}
        </div>
        <div class="hx-notification__content">
          <slot>
      ...
      <div class="hx-notification__close" v-if="showClose">
